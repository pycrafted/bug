    ...
    <?php if ($featured): ?>
        <section class="featured">
            ...
            <div class="featured-article">
                <img src="<?php echo BASE_URL; ?>/<?php echo safeHtml($featured['image']); ?>" alt="<?php echo safeHtml($featured['titre']); ?>">
                <div class="featured-content">
                    <h2><?php echo safeHtml($featured['titre']); ?></h2>
                    <p><?php echo truncateText(safeHtml($featured['contenu']), 200); ?></p>
                    <a href="<?php echo BASE_URL; ?>/article/<?php echo $featured['id']; ?>" class="read-more">Lire l'article</a>
                </div>
            </div>
        </section>
    <?php else: ?>
            ...
            <?php if (!empty($articles)): ?>
                <?php foreach ($articles as $article): ?>
                    <article class="article-card">
                        <img src="<?php echo BASE_URL; ?>/<?php echo safeHtml($article['image']); ?>" alt="<?php echo safeHtml($article['titre']); ?>">
                        <div class="article-content">
                            ...
                            <a href="<?php echo BASE_URL; ?>/article/<?php echo $article['id']; ?>" class="read-more">Lire la suite</a>
                        </div>
                    </article>
                <?php endforeach; ?>
            <?php else: ?>
